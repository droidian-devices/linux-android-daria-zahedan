...
KERNEL_BOOTIMAGE_CMDLINE = bootopt=64S3,32N2,64N2 buildvariant=userdebug console=tty0 droidian.lvm.prefer v4l2loopback.devices=2 v4l2loopback.video_nr=0,1 v4l2loopback.card_label=Droidian_back,Droidian_front v4l2loopback.exclusive_caps=1,1 v4l2loopback.max_buffers=2
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:armhf, binutils-aarch64-linux-gnu, clang-android-12.0-r416183b, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross
